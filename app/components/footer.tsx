    ...
    <footer className="footer footer-center p-10 bg-base-100 text-base-content rounded">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <Link href="https://www.facebook.com/ElevationFitnessGym">
            <svg
          ...
          <Link href="https://www.instagram.com/elevationfitnessgym.dvo/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              width="24px"
          ...
          <Link href="https://www.tiktok.com/@elevationfitnessgym17">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              width="24px"
